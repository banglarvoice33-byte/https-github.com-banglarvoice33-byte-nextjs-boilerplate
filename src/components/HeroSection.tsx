...
const heroSlides = [
  ...
  {
    title: 'প্রধানমন্ত্রীর নেতৃত্বে নতুন উন্নয়ন প্রকল্পের উদ্বোধন',
    summary: 'দেশের দক্ষিণাঞ্চলে ১০টি নতুন সেতু ও বিদ্যুৎ প্রকল্পের উদ্বোধন করেছেন প্রধানমন্ত্রী। এতে লাখো মানুষের জীবনমান উন্নয়ন হবে।',
    image: 'https://images.pexels.com/photos/2422589/pexels-photo-2422589.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    category: 'জাতীয়',
    readTime: 4,
    views: '৮.২K',
  },
  {
    title: 'বাংলাদেশ-ভারত জলবায়ু চুক্তি: নতুন যুগের সূচনা',
    summary: 'দুই দেশের মধ্যে জলবায়ু সহযোগিতা চুক্তি সই হয়েছে। পদ্মা নদীর পানি ব্যবস্থাপনা ও বন্যা পূর্বাভাসে যৌথ কার্যক্রম চালু হবে।',
    image: 'https://images.pexels.com/photos/1485894/pexels-photo-1485894.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
